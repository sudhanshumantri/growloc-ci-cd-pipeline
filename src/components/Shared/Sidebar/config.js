const menuItems = [
    ...
    },
    {
        ...
        id: "crop",
        navigation: 'corp',
        subMenu: [{ id: '1', name: 'Manage Crops' , navigation : 'crop/manage',},{ id: '2', name: 'Plan Schedules' , navigation : 'crop/plans',},{ id: '3', name: 'Seeding', navigation : 'crop/seeding', }, { id: '4', name: 'Planting' , navigation : 'crop/planting'}, {id: '5', name: 'Transplanting', navigation : 'crop/transplanting'}]
