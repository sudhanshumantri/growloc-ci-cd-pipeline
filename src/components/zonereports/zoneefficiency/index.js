...
export default function ZoneEfficiency({ zoneReportsList,fetchZoneReports,isZoneReportsListLoading}) {
    ...
    useEffect(() => {
      ...
      console.log(phValues, "phValues", "zone");
      console.log(waterTempValues, "waterTempValues","zone");
      console.log(lightIntensitValues, "lightIntensitValues","zone");
      console.log(humidityValues, "humidityValues","zone");
    console.log(zoneReportsList,"zoneReportsList",);
    ...
    return (
      <>
        ...
        <div className="page-container">
            {isZoneReportsListLoading && <Loader title="Fetching zone reports details"/>}
