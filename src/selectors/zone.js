...
export const selectFarmZoneList = () =>
  createSelector(selectZone, (services) => services.toJS().farmZoneList)
export const selectIsFarmZoneLoading = () =>
  createSelector(selectZone, (services) => services.toJS().isFarmZoneLoading)

export const selectFarmZoneError = () =>
  createSelector(selectZone, (services) => services.toJS().farmZoneError)

export const selectFarmZoneDashboardList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().farmZoneDashboardList
  )
...
export const selectFarmZoneDashboardListError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().farmZoneDashboardListError
  )

export const selectFarmZoneDashboardHarvestList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().farmZoneDashboardHarvestList
  )
...
export const selectFarmZoneDashboardHarvestListError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().farmZoneDashboardHarvestListError
  )
...
export const selectFarmDashboardZoneTaskError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().farmDashboardZoneTaskError
  )
...
export const selectFarmDashboardZoneCommetError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().farmDashboardZoneCommetError
  )
...
export const selectZoneDashboardZoneInfoList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneInfoList
  )
...
export const selectZoneDashboardZoneInfoError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneInfoError
  )
export const selectZoneDashboardZoneCropSchedulesList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneCropSchedulesList
  )
...
export const selectZoneDashboardZoneCropSchedulesListError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneCropSchedulesListError
  )

export const selectZoneDashboardZoneTaskList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneTaskList
  )
...
export const selectZoneDashboardZoneTaskListError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneTaskListError
  )
export const selectZoneDashboardZoneSensorList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneSensorList
  )
...
export const selectZoneDashboardZoneSensorError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneSensorError
  )

export const selectZoneDashboardZoneUtilizationCropsList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneUtilizationCropsList
  )
...
export const selectZoneDashboardZoneUtilizationCropsError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneUtilizationCropsError
  )

export const selectZoneDashboardZoneUtilizationStagesList = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneUtilizationStagesList
  )
...
export const selectZoneDashboardZoneUtilizationStagesError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneDashboardZoneUtilizationStagesError
  )

export const selectZoneTaskList = () =>
  createSelector(selectZone, (services) => services.toJS().zoneTaskList)
...
export const selectZoneTaskListError = () =>
  createSelector(selectZone, (services) => services.toJS().FarmTaskListError)
...
export const selectZoneTaskCommentError = () =>
  createSelector(
    selectZone,
    (services) => services.toJS().zoneTaskCommentError
  )
