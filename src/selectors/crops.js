...
export const selectIsCropListLoading = () =>
  createSelector(selectCrop, (services) => services.toJS().isCropListLoading)
...
export const selectIsUpdateFarmCropsLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isupdateFarmCropsLoading
  )
export const selectIsUpdateFarmCropsError = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isupdateFarmCropsError
  )

export const selectIsDeleteFarmCropsLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isdeleteFarmCropsLoading
  )
