...
export const selectFarmDashboardHarvestList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().dashboardHarvestList
  )
...
export const selectFarmDashboardHarvestListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().DashboardHarvestListError
  )
...
export const selectTaskScheduleTaskListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().TaskScheduleTaskListError
  )
...
export const selectfarmTaskCommentError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmTaskCommentError
  )
...
export const selectFarmDashboardZoneError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneError
  )

export const selectFarmDashboardZoneList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneList
  )
...
export const selectFarmDashboardZoneListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneListError
  )
...
export const selectUpdateFarmDashboardZoneError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().updateFarmDashboardZoneError
  )
...
export const selectAllUserZoneSensor = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().allZoneSensorList
  )
...
export const selectLoadingAllZoneSensorError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().loadingAllZoneSensorError
  )

export const selectFarmDashboardFarmInfoList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardFarmInfoList
  )
...
export const selectFarmDashboardFarmInfoListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardFarmInfoListError
  )

export const selectFarmDashboardCropSchedulesList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardCropSchedulesList
  )
...
export const selectFarmDashboardCropSchedulesListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardCropSchedulesListError
  )

export const selectFarmDashboardInfoList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardInfoList
  )
...
export const selectFarmDashboardInfoListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardInfoListError
  )

export const selectFarmDashboardTaskList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardTaskList
  )
...
export const selectFarmDashboardTaskListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardTaskListError
  )

export const selectFarmDashboardFarmUtilizationCropsList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardFarmUtilizationCropsList
  )
...
export const selectFarmDashboardFarmUtilizationCropsError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().FarmDashboardFarmUtilizationCropsError
  )
export const selectFarmDashboardFarmUtilizationStagesList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardFarmUtilizationStagesList
  )
...
export const selectFarmDashboardFarmUtilizationStagesError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardFarmUtilizationStagesError
  )

export const selectFarmDashboardZoneSensorList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneSensorList
  )
...
export const selectFarmDashboardZoneSensorListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneSensorListError
  )

export const selectFarmDashboardZoneLattestSensorList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneLattestSensorList
  )
...
export const selectFarmDashboardZoneLattestSensorListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardZoneLattestSensorListError
  )

export const selectFarmDashboardAllZoneDetailsList = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardAllZoneDetailsList
  )
export const selectIsFarmDashboardAllZoneDetailsLoading = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().isFarmDashboardAllZoneDetailsLoading
  )
export const selectFarmDashboardAllZoneDetailsListError = () =>
  createSelector(
    selectFarmDashboard,
    (services) => services.toJS().farmDashboardAllZoneDetailsListError
  )
