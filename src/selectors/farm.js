...
export const selectIsFarmListLoading = () =>
  createSelector(selectFarm, (services) => services.toJS().isFarmListLoading)
...
export const selectIsUpdateFarmLoading = () =>
  createSelector(selectFarm, (services) => services.toJS().isUpdateFarmLoading)
...
export const selectIsDeleteFarmLoading = () =>
  createSelector(selectFarm, (services) => services.toJS().isdeleteFarmLoading)
