...
export const selectCropLifeCycleListError = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().cropLifeCycleListError
  )
export const selectIsCropLifeCycleListLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isCropLifeCycleListLoading
  )
...
export const selectIsAddLifecycleLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isAddLifecycleLoading
  )
...
export const selectLifecycleDetailsError = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().lifeCycleDetailsError
  )
export const selectIsLifecycleDetailsLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isLifeCycleDetailsLoading
  )
...
export const selectIsLifecycleParametersLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isAddLifecycleParametersLoading
  )
export const selectLifecycleParametersError = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().addLifecycleParameterError
  )

export const selectIsUpdateLifeCycleDetailsLoading = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isUpdateLifeCycleDetailsLoading
  )
export const selectIsUpdateLifeCycleDetailsError = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isUpdateLifeCycleDetailsError
  )

export const selectIsUpdateLifecycleStageScheduleRequested = () =>
  createSelector(
    selectCrop,
    (services) => services.toJS().isUpdateLifecycleStageScheduleRequested
  )
