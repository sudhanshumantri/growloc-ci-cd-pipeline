...
import {
  callfetchFarmZoneDetails,
  callFetchDashboardFarmZoneList,
  callFetchFarmDashboardZoneHarvestList,
  callAddFarmDashboardZoneTask,
  callAddFarmDashboardZoneTaskComment,
  callfetchRecenzoneSensorData,
  callFetchZoneDashboardZoneInfoList,
  callfetchZoneDashobardZoneCropSchedulekDetails,
  callfetchZoneDashobardZoneTaskDetails,
  callfetchZoneDashobardZoneSensorsDetails,
  callFetchDashboardFarmZoneUtilizationCrops,
  callFetchDashboardFarmZoneUtilizationStages,
  callfetchZoneTaskDetails,
  callAddZoneTaskComment,
  callfetchFarmZoneSensorDetails
} from '../utils/api'
import {
...
export function * fetchFarmZoneList ({ data }) {
  const responseData = yield call(callfetchFarmZoneDetails, data)
...
export function * fetchFarmZoneDashboardList ({ data }) {
  const responseData = yield call(callFetchDashboardFarmZoneList, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchFarmZoneDashboardHarvestList ({ data }) {
  const responseData = yield call(callFetchFarmDashboardZoneHarvestList, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * addFarmDashboardZoneTask ({ data }) {
  const responseData = yield call(callAddFarmDashboardZoneTask, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * addFarmDashboardZoneComment ({ data }) {
  const responseData = yield call(callAddFarmDashboardZoneTaskComment, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchRecentZoneSensorData ({ data }) {
  const responseData = yield call(callfetchRecenzoneSensorData, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchZoneDashboardZoneInfoList ({ data }) {
  const responseData = yield call(callFetchZoneDashboardZoneInfoList, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchZoneDashboardZoneCropScheduleList ({ data }) {
  ...
  if (responseData?.status === 200 && responseData.data.status) {
    yield put(
      fetchZoneDashboardZoneCropScheduleSuccess(responseData.data.data)
    )
  } else {
    yield put(
      fetchZoneDashboardZoneCropScheduleFailure('Something went wrong')
    )
  }
}
export function * fetchZoneDashboardZoneTaskScheduleList ({ data }) {
  ...
  if (responseData?.status === 200 && responseData.data.status) {
    ...
    yield put(
      fetchZoneDashboardZoneTaskScheduleFailure('Something went wrong')
    )
  }
}
...
export function * fetchZoneDashboardZoneUtilizationCropsList ({ data }) {
  ...
  if (responseData?.status === 200 && responseData.data.status) {
    yield put(
      fetchZoneDashboardZoneUtilizationCropsSuccess(responseData.data.data)
    )
  } else {
    yield put(
      fetchZoneDashboardZoneUtilizationCropsFailure('Something went wrong')
    )
  }
}
export function * fetchZoneDashboardZoneUtilizationStagesList ({ data }) {
  ...
  if (responseData?.status === 200 && responseData.data.status) {
    yield put(
      fetchZoneDashboardZoneUtilizationStagesSuccess(responseData.data.data)
    )
  } else {
    yield put(
      fetchZoneDashboardZoneUtilizationStagesFailure('Something went wrong')
    )
  }
}
...
export function * addZoneTaskComment ({ data }) {
  const responseData = yield call(callAddZoneTaskComment, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchFarmZoneSensorDataList ({ data }) {
  ...
  const responseData = yield call(callfetchFarmZoneSensorDetails, remaingData)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * zoneSagas () {
  yield all([
    ...
    takeLatest(
      ...
      fetchFarmZoneDashboardList
    ),
    takeLatest(
      'FETCH_ALL_FARM_ZONE_DASHBOARD_HARVEST_REQUEST',
      fetchFarmZoneDashboardHarvestList
    ),
    takeLatest(
