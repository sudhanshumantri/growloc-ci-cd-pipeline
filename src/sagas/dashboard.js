...
export function * addTaskScheduleTask ({ data }) {
  const responseData = yield call(callAddTaskScheduleTask, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * addFarmTaskComment ({ data }) {
  const responseData = yield call(callAddFarmTaskComment, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * addFarmDashboardZone ({ data }) {
  const responseData = yield call(callAddFarmDashboardZone, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * updateFarmDashboardZoneList ({ data }) {
  ...
  const responseData = yield call(callUpdateFarmDashboardZoneList, payload, id)
...
export function * deleteFarmDashboardZoneList ({ data }) {
  const responseData = yield call(callDeleteFarmDashboardZoneList, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchAllUserZoneSensor ({ data }) {
  const responseData = yield call(callFetchAllUserZoneSensor, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchFarmDashboardInfoList ({ data }) {
  const responseData = yield call(callFetchDashboardInfoFarmList, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchFarmDashboardFarmInfoList ({ data }) {
  const responseData = yield call(callFetchDashboardFarmInfo, data)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchFarmDashboardFarmUtlizationCropList ({ data }) {
  const responseData = yield call(callFetchDashboardFarmUtilizationCrops, data)
  if (responseData?.status === 200 && responseData.data.status) {
    yield put(
      fetchFarmDashboardUtilizationCropsSuccess(responseData.data.data)
    )
  } else {
    yield put(
      fetchFarmDashboardUtilizationCropsFailure('Something went wrong')
    )
  }
}
export function * fetchFarmDashboardFarmUtlizationStagesList ({ data }) {
  ...
  if (responseData?.status === 200 && responseData.data.status) {
    yield put(
      fetchFarmDashboardUtilizationStagesSuccess(responseData.data.data)
    )
  } else {
    yield put(
      fetchFarmDashboardUtilizationStagesFailure('Something went wrong')
    )
  }
}
export function * fetchFarmDashboardZoneSensorDataList ({ data }) {
  const { ...id } = data
  const responseData = yield call(callfetchFarmDashboardZoneSensorDetails, id)
  if (responseData?.status === 200 && responseData.data.status) {
...
export function * fetchFarmDashboardZoneLattestSensorDataList ({ data }) {
  ...
  if (responseData?.status === 200 && responseData.data.status) {
    yield put(
      fetchDashboardFarmLattestSensorDataSuccess(responseData.data.data)
    )
  } else {
    yield put(
      fetchDashboardFarmLattestSensorDataFailure('Something went wrong')
    )
  }
}
