...
export default function dashboardReducer (state = INITIAL_STATE, action = {}) {
  const farmDashboardZoneList = state.toJS().farmDashboardZoneList
  const farmDashboardTaskList = state.toJS().farmDashboardTaskList
  ...
  switch (action.type) {
    ...
    case ADD_FARM_TASKS_COMMENTS_SUCCESS: {
      ...
      farmDashboardTaskList.tasks[taskRow].status = action.data.status
      return state
    ...
    case DELETE_FARM_DASHBOARD_ZONE_SUCCESS: {
      ...
      const newfarmDashboardZoneList = {
        ...farmDashboardZoneList,
